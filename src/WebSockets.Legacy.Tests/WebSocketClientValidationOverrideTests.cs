...
public class WebSocketClientValidationOverrideTests
{
    ...
    {
        // Proves overrides are genuinely bidirectional, not just a way to
        // loosen the default: "Upgrade" alone passes the default check, but
        // an override can still reject it.
