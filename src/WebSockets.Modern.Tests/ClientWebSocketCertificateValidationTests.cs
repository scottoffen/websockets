...
public class ClientWebSocketCertificateValidationTests
{
    ...
    // This is the faithful, combined replica of the actual bug report: a
    // working certificate bypass does NOT rescue the connection from the
    // Connection-header bug, since the two checks happen at separate,
    // independent stages of the handshake. This is the test that most 
    // directly debunks "it works on .NET 5.0."
    [Fact]
