...
- [ ] Follows the [contribution guidelines](https://github.com/scottoffen/websockets)$/blob/main/.github/contributing.md) and C# conventions, with readability as a priority
